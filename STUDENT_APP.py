...
def load_and_flatten_data():
    ...
    try:
        ...
        for item in questions:
            ...
            # Final cleanup: Move generic 'Science' to specific subjects
            if item['Subject'] == "Science":
                t = item.get('Topic', '')
                # Class 10 & 9 Physics
                if t in ["Refraction", "Electricity", "Magnetic Effects of Electric Current", "Sources of Energy", "Light", "Human Eye", "Motion", "Force and Laws of Motion", "Gravitation", "Work and Energy", "Sound"]:
                    item['Subject'] = "Physics"
                # Class 10 & 9 Chemistry
                elif t in ["Acids, Bases and Salts", "Chemical Reactions and Equations", "Metals and Non-metals", "Carbon and its Compounds", "Matter in Our Surroundings", "Is Matter Around Us Pure", "Atoms and Molecules", "Structure of the Atom"]:
                    item['Subject'] = "Chemistry"
                # Class 10 & 9 Biology
                elif t in ["Life Processes", "Control and Coordination", "How do Organisms Reproduce?", "Heredity and Evolution", "Our Environment", "The Fundamental Unit of Life", "Tissues", "Diversity in Living Organisms", "Why Do We Fall Ill", "Natural Resources", "Improvement in Food Resources"]:
